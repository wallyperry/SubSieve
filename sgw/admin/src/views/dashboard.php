  ...
  <div class="content">
    ...
    <div class="tab-panel active" id="panel-logs">
      <div class="card">
        ...
        <div class="log-controls">
          ...
          <input class="log-filter" id="filter-token" placeholder="过滤 Token（/s/ 后的路径段，自动去重）" oninput="logPage=1;renderLogs()">
    ...
    <div class="tab-panel" id="panel-token_blacklist">
      <div class="card">
        ...
        <div class="ip-form">
          <input class="ip-input" id="tb-token" placeholder="完整 Token（/s/ 后的路径段）">
        ...
        <div class="card">
          ...
          <div style="display:flex;flex-direction:column;gap:12px">
            ...
            <div>
              ...
              <input class="ip-input" id="cfg-subscribe-path" placeholder="/s/" value="<?= _val($_preSg['subscribe_path'] ?? DEFAULT_SUBSCRIBE_PATH) ?>" style="width:100%">
              <div class="apply-hint" style="color:#64748b;font-size:11px;margin-top:4px">XBoard 订阅格式：<code>/s/{token}</code>，Token 在路径中而非 query 参数</div>
            </div>
...
async function loadSettings() {
  ...
  document.getElementById('cfg-subscribe-path').value  = currentSettings.subscribe_path || SUBSCRIBE_PATH_PREFIX || '/s/';
  // 填充网关端口
